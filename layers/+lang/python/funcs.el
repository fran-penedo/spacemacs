...
(defun spacemacs/python-annotate-pdb ()
  ...
  (highlight-lines-matching-regexp "__import__(\"pdb\").set_trace() # FIXME")
...
(defun spacemacs/python-toggle-breakpoint ()
  ...
  (let ((trace (cond ((spacemacs/pyenv-executable-find "trepan3k") "import trepan.api; trepan.api.debug()")
                     ...
                     ;; ((spacemacs/pyenv-executable-find "ipdb") "__import__(\"pdb\").set_trace() # FIXME")
                     ((spacemacs/pyenv-executable-find "pudb") "import pudb; pudb.set_trace()")
                     ;; ((spacemacs/pyenv-executable-find "ipdb3")  "__import__(\"pdb\").set_trace() # FIXME")
                     ...
                     (t  "__import__(\"pdb\").set_trace() # FIXME")))
